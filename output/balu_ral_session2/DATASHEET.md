...
|----------------------------------|------------|------------|
| Requirements specification       | ✓ Complete | 2026-04-18 |
| VCRM — 141 requirements          | ✓ Complete | 2026-04-18 |
| Register map spreadsheet         | Pending    | —          |
| VHDL entity + architecture stub  | Pending    | —          |
| SystemVerilog module + stub      | ✓ Complete | 2026-04-18 |
...
```systemverilog
buffered_axi_lite_uart u_buffered_axi_lite_uart (
    axi_aclk           => clk_s,
